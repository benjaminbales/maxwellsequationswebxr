...
var TransformControls = function ( camera, domElement, controller) {
	...
	var selectStartEvent = { type: "selectStart"};
	var mouseUpEvent = { type: "mouseUp", mode: scope.mode };
	var selectEndEvent = { type: "selectEnd", mode: scope.mode};
...

	{
		...
		controller.addEventListener( "select", onPointerHover );
		controller.addEventListener( "select", onPointerMove );
		document.addEventListener( "mouseup", onPointerUp, false );
		domElement.addEventListener( "touchend", onPointerUp, false );
		domElement.addEventListener( "touchcancel", onPointerUp, false );
		domElement.addEventListener( "touchleave", onPointerUp, false );
		controller.addEventListener( "selectend", onPointerUp );
		// controller.addEventListener( "select", onPointerUp );
	...
	this.dispose = function () {
		...
		controller.removeEventListener( "selectstart", onPointerDown );
		domElement.removeEventListener( "mousemove", onPointerHover );
		document.removeEventListener( "mousemove", onPointerMove );
		domElement.removeEventListener( "touchmove", onPointerHover );
		domElement.removeEventListener( "touchmove", onPointerMove );
		controller.removeEventListener( "select", onPointerHover );
		controller.removeEventListener( "select", onPointerMove );
		document.removeEventListener( "mouseup", onPointerUp );
		domElement.removeEventListener( "touchend", onPointerUp );
		domElement.removeEventListener( "touchcancel", onPointerUp );
		domElement.removeEventListener( "touchleave", onPointerUp );
		controller.removeEventListener( "selectend", onPointerUp );
		// controller.removeEventListener( "select", onPointerUp );
	...
	this.pointerHover = function ( pointer ) {
		// console.log("pointerHover pointer is ");
		// console.log(pointer);
	...
	this.pointerDown = function ( pointer ) {
		// console.log("pointerDown pointer is ");
		// console.log(pointer);
		if ( this.object === undefined || this.dragging === true || ( pointer.button !== undefined && pointer.button !== 0 ) ) return;
			// console.log(this.axis);
			// console.log(pointer.button);
		if ( ( pointer.button === 0 || pointer.button === undefined ) && this.axis !== null ) {
			// console.log("pointerDown made it this far.");
	...
	this.pointerUp = function ( pointer ) {
		// console.log("pointerUp pointer is ");
		// console.log(pointer);
...
//REPLACE THIS WITH XR COMPATIBLE VERSION THAT USES RENDERER.XR.CONTROLLER.MATRIXWORLD.
//The event parameter is an event object from https://developer.mozilla.org/en-US/docs/Web/API/Event
//the does not include webxr select and squeeze events.  I will need to trigger a different event. and then process it here
//to make it look like a touch event. 
	function getPointer( event ) {
		// console.log("getPointer event is ");
		// console.log(event);
		// console.log("getPointer event is " + event.eventInitDict);
		// console.log("controller is " + controller);
		// console.log(controller);
		// console.log("controller.targetRay is " + controller.targetRay);
		...
		if ( document.pointerLockElement ) {
			...
			if(event.type === "selectstart" || event.type === "select" || event.type === "selectend"){
				var pointer = event.target.position;
				// console.log("pointer is ");
				// console.log(pointer);
				var rect = domElement.getBoundingClientRect();
				return {
					x: (pointer.x - rect.left) / rect.width * 2 - 1,
					y: - (pointer.y - rect.top) / rect.height * 2 + 1,
					button: event.button
				};
			}else{
	...
	function onPointerDown( event ) {
		...
		controller.addEventListener("select", onPointerMove, false);
	...
	function onPointerUp( event ) {
		...
		controller.removeEventListener( "select", onPointerMove, false );
